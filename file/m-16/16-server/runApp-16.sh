...
CA_FILE=/home/user/etc/docker-compose-ca.yaml
...
#		docker-compose -f $COMPOSE_FILE -f $COMPOSE_FILE_WITH_COUCH up -d
		...
		echo ".............................................................."
#		sleep 10
		sshpass -p "user" ssh -o StrictHostKeyChecking=no 192.168.1.101 "docker-compose -f $CA_FILE up -d"
		sshpass -p "user" ssh -o StrictHostKeyChecking=no 192.168.1.102 "docker-compose -f $CA_FILE up -d"
...
#	docker-compose -f $COMPOSE_FILE -f $COMPOSE_FILE_WITH_COUCH down
		...
		sshpass -p "user" ssh -o StrictHostKeyChecking=no 192.168.1.101 "docker-compose -f $CA_FILE down"
		sshpass -p "user" ssh -o StrictHostKeyChecking=no 192.168.1.102 "docker-compose -f $CA_FILE down"
